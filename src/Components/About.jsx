  ...
  return (
    <div className="aboutdetails">
        ...
        <ol>
          <li id="devices">
            ...
            <ul>
              ...
              <li>X-Box</li>
              <li>
                And all kinds of gaming accessories like mouse, pads, keyboards,
                and so on.
              </li>
            </ul>
          </li>
      ...
      <div className="div82">
        <p id="secondline">
          {" "}
          NOT only this much we provide and built your Desktops according to
